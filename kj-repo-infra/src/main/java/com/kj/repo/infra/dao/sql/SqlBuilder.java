package com.kj.repo.infra.dao.sql;
...
public abstract class SqlBuilder {
    ...
    private static final ConcurrentMap<DAO.DBType, SqlBuilder> BUILDERS = Maps.newConcurrentMap();
    private static Logger logger = LoggerHelper.getLogger();

    static {
        register(DAO.DBType.MYSQL, new MysqlBuilder());
    }

    public static SqlBuilder sqlBuilder(DAO.DBType dbType) {
        return BUILDERS.get(dbType);
    }

    public static void register(DAO.DBType dbType, SqlBuilder sqlBuilder) {
