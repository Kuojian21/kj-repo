 ...
 * @author kj
 */
public class ConcurrentMapBatchBuffer<E, K, V> implements BatchBuffer<E, Entry<K, V>> {
    ...
    public ConcurrentMapBatchBuffer(Function<E, K> keyMapper, Function<E, V> valMapper) {
        this(keyMapper, valMapper, (v1, v2) -> v1);
    }

    public ConcurrentMapBatchBuffer(Function<E, K> keyMapper, Function<E, V> valMapper, BiFunction<V, V, V> valMerger) {
