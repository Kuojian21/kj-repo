...
public class TeBrowser {
    ...
    public static List<String> git(Browser browser, String[] args) throws Exception {
        ...
        browser.execute(t -> {
            ...
            do {
                ...
                List<String> p = BrowserHelper.parse(page, "//a[@class='project']/@href");
                rtn.addAll(p);
    ...
    public static void gatherproxy(Browser browser, String[] arg) throws Exception {
        ...
        List<String> urls = browser.execute(w -> {
            ...
            return BrowserHelper.parse(page, "//ul[@class='pc-list']/li/a");
        });
        ...
        for (String url : urls) {
            executor.submit(() -> {
                try {
                    logger.info("{}", url);
                    browser.execute(w -> {
                        List<String> rows = BrowserHelper.parse(w.getPage(url),
