    ...
    public static class SavorTestDao<T> extends Savor<T> {
        ...
        public Function<Object, ShardHolder> shard() {
            return (v) -> {
                ...
                Long id = (Long) v;
                id = id % 10;
                return new ShardHolder(id % 2 == 0 ?
                        new JdbcTemplateHolder(jdbcTemplate1, jdbcTemplate1) :
                        new JdbcTemplateHolder(jdbcTemplate2, jdbcTemplate2),
